    ...
    <a href="https://music.amazon.com/artists/B0171RLIKU/jennifer-gonzalez">
      <svg viewBox="0 0 89 52">
        <g transform="translate(-.5 -18)">
          ...
          <path
            fill="url(#b)"
            d="M44 26v13.3a9.4 9.4 0 0 1-5 1.7c-1 0-2-.3-2.4-.9-.5-.6-.7-1.5-.7-2.8V26c0-.5-.2-.7-.7-.7H33c-.5 0-.7.2-.7.7v12.4c0 1.7.4 3 1.3 4 .9.9 2.2 1.4 3.8 1.4 2.3 0 4.6-.8 6.8-2.4l.2 1.2c0 .3.1.4.3.5l.6.1h1.5c.5 0 .7-.2.7-.7V26c0-.5-.2-.7-.7-.7h-2c-.6 0-.8.3-.8.7z"
          />
          <linearGradient
            id="c"
            x1="-349.9"
          ...
          <path
            fill="url(#d)"
            d="M79.5 56.7a88.3 88.3 0 0 1-77.6-4.8l-.6-.2c-.7 0-1.1.8-.4 1.5a65.2 65.2 0 0 0 80 5.8c1.7-1.2.3-3-1.4-2.3z"
          />
          <linearGradient
            id="e"
            x1="-349.9"
          ...
          <path
            fill="url(#e)"
            d="M79.2 29.4c.9-1 2.3-1.5 4.3-1.5 1 0 2 .1 2.9.4l.6.1c.3 0 .5-.2.5-.7v-1l-.2-.7-.5-.4c-1.3-.3-2.6-.6-3.8-.6-2.8 0-4.9.8-6.5 2.5a10 10 0 0 0-2.3 7c0 3 .7 5.3 2.2 7 1.5 1.6 3.6 2.4 6.4 2.4 1.5 0 3-.2 4-.7.3-.1.5-.2.6-.4l.1-.7v-1c0-.5-.2-.7-.5-.7a12.5 12.5 0 0 1-3.7.6c-2 0-3.3-.5-4.2-1.5-.9-1-1.3-2.6-1.3-4.7v-.5c.1-2.2.5-3.8 1.4-4.8z"
          />
          <linearGradient
            id="f"
            x1="-349.9"
          ...
          <path
            fill="url(#f)"
            d="M83.7 66c5.2-4.4 6.6-13.5 5.5-15-.5-.6-3-1.2-6-1.2-3.2 0-7 .7-10 2.7-.9.6-.7 1.4.2 1.3 3-.4 10-1.2 11.4.4 1.2 1.6-1.4 8.2-2.6 11-.3.9.4 1.2 1.3.6z"
          />
          <linearGradient
            id="g"
            x1="-349.9"
          ...
          <path
            fill="url(#g)"
            d="M69.8 25.4h-2c-.5 0-.7.2-.7.7v16.6c0 .5.2.7.7.7h2c.5 0 .7-.2.7-.7V26c0-.4-.2-.7-.7-.7z"
          />
          <linearGradient
            id="h"
            x1="-349.9"
          ...
          <path
            fill="url(#h)"
            d="M70.4 18.6c-.4-.4-1-.6-1.7-.6s-1.2.2-1.6.6a2 2 0 0 0-.6 1.5c0 .6.2 1.2.6 1.5.4.4.9.6 1.6.6.7 0 1.2-.2 1.6-.6.4-.4.6-.9.6-1.5s-.1-1.2-.5-1.5z"
          />
        </g>
      </svg>
    </a>
