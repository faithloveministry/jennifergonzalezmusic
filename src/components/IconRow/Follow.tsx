...
export const Follow = () => (
  <div class={styles.IconRow}>
    <a href="https://www.facebook.com/jennifer.gonzalez.58760" aria-label="Facebook">
    ...
    <a href="https://www.instagram.com/jennifergonzalezmusic" aria-label="Instagram">
    ...
    <a href="https://www.youtube.com/@JenniferGonzalezMusic" aria-label="YouTube">
      <svg viewBox="0 0 461 461">
        <path d="M365 67H96c-53 0-96 43-96 96v135c0 53 43 96 96 96h269c53 0 96-43 96-96V163c0-53-43-96-96-96zm-64 170-127 60c-3 2-7-1-7-4V169c0-4 4-7 8-5l126 64c3 2 3 7 0 9z" />
      </svg>
    </a>
    <a href="https://www.tiktok.com/@jennifergonzalezmusic" aria-label="TikTok">
      <svg viewBox="0 0 24 24">
        <path d="M19.6 6.7a4.8 4.8 0 0 1-3.8-4.3V2h-3.4v13.7a2.9 2.9 0 0 1-5.2 1.7 2.9 2.9 0 0 1 3.2-4.5V9.4A6.3 6.3 0 0 0 5 20.1a6.3 6.3 0 0 0 10.8-4.4v-7a8.2 8.2 0 0 0 4.8 1.5V6.8a4.8 4.8 0 0 1-1-.1z" />
      </svg>
    </a>
  </div>
);
