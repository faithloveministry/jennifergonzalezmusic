      ...
      terserOptions:
        mode === 'production'
          ? {
              ...
              mangle: { properties: { regex: /^(?:owned|cleanups|owner|observerSlots|comparator|sourceSlots|running|disposed|tState|updatedAt|pure|suspense|inFallback|effects|_\$host|\$\$click|numPages|\$\$touchend|_v\$|_v\$2|_v\$3|_v\$4|_v\$5|_v\$6|_v\$7|_v\$8|_v\$9|_v\$10)$/ } }, //prettier-ignore
            }
          : undefined,
